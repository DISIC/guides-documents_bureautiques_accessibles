...
* Microsoft Word 2013&nbsp;: [ODT - 3,1Mo](./MicrosoftOfficeWord.odt), [PDF - 6,2Mo](./MicrosoftOfficeWord.pdf)
* Microsoft Excel 2013&nbsp;: [ODT - 2Mo](./MicrosoftOfficeExcel.odt), [PDF - 4,1Ko](./MicrosoftOfficeExcel.pdf)
* Microsoft PowerPoint 2013&nbsp;: [ODT - 1,7Mo](./MicrosoftOfficePowerPoint.odt), [PDF - 3,6Mo](./MicrosoftOfficePowerPoint.pdf)
* LibreOffice Writer 4.3&nbsp;: [ODT - 2Mo](./LibreOfficeWriter.odt), [PDF - 4,4Mo](./LibreOfficeWriter.pdf)
* LibreOffice Calc 4.3&nbsp;: [ODT - 1,7Mo](./LibreOfficeCalc.odt), [PDF - 3,5Mo](./LibreOfficeCalc.pdf)
* LibreOffice Impress 4.3&nbsp;: [ODT - 1,4Mo](./LibreOfficeImpress.odt), [PDF - 3,2Mo](./LibreOfficeImpress.pdf)
* Adobe Acrobat Pro Document Cloud 2015&nbsp;: [ODT - 3,2Mo](./AdobeAcrobatPro.odt), [PDF - 6,8Mo](./AdobeAcrobatPro.pdf)
...
Un vérificateur de contraste permet de déterminer si les couleurs utilisées ont un contraste suffisant. Le Color Contrast Analyser du Paciello Group peut être téléchargé gratuitement à l'adresse suivante&nbsp;: https://www.paciellogroup.com/resources/contrastanalyser/

Un vérificateur en ligne est également proposé par Tanaguru à l'adresse&nbsp;: http://contrast-finder.tanaguru.com/?lang=fr
...
* Commencer avec «&nbsp;image de..&nbsp;» ou « photo de… ».
...
* Privilégiez l'emploi de styles de lignes en pointillées afin d’améliorer la lisibilité&nbsp;;
* Si nécessaire, remplacez les couleurs prédéfinies pour respecter les exigences de contraste.
...
* Évitez d’imbriquer les tableaux les uns dans les autres.
* Dans la mesure du possible évitez de fusionner des cellules.
* Éliminez les cellules vides – si une donnée est absente, la remplacer par une mention explicite.
* Générez des lignes blanches à l’aide des styles et non pas en insérant des lignes vides.
* Évitez d’insérer des images au sein du tableau.
